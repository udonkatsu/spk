...
function get_rel_alternatif($kriteria = '')
{
    ...
    // Periksa apakah 'q' sudah didefinisikan dalam array $_GET
    $search_query = isset($_GET['q']) ? esc_field($_GET['q']) : '';
    ...
    $rows = $db->get_results("SELECT
       ...
       WHERE nama_alternatif LIKE '%" . $search_query . "%'
...
function consistency_measure($matriks, $rata)
{
    ...
    $data = array(); // Tambahkan inisialisasi variabel $data
    foreach ($matriks as $key => $value) {
